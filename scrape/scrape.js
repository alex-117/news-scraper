...
module.exports = function(app) {
    ...
    // Making a request for reddit's "webdev" board. The page's HTML is passed as the callback's third argument
    request("http://blog.counter-strike.net/index.php/page/2/", function (error, response, html) {
    ...
    // Making a request for reddit's "webdev" board. The page's HTML is passed as the callback's third argument
    request("http://blog.counter-strike.net/index.php/page/3/", function (error, response, html) {
